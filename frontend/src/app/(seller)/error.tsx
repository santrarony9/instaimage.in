...
export default function Error({
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 px-4 text-center">
      <h2 className="text-2xl font-bold mb-4">Seller Portal Error</h2>
      <p className="text-gray-600 mb-8 max-w-md">Something went wrong in the seller portal. Your data is safe — please try again.</p>
