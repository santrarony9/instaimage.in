...
const links = [
  { href: '/photographer', label: 'Schedule & Assignments' },
];
  ...
  const NavContent = () => (
    <div className="flex flex-col h-full bg-white border-r w-64">
      <div className="p-4 border-b flex items-center gap-3">
        ...
        <div className="font-semibold truncate">Pro Portal</div>
      </div>
      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="bg-white shadow-sm md:hidden">
          <div className="px-4 py-3 flex items-center">
            ...
            <span className="ml-4 font-semibold text-lg">Pro Portal</span>
          </div>
        </header>
