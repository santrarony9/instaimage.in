        ...
        <div className="space-y-4">
          ...
          <form className="mt-4 space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-3">
              <div>
                <label htmlFor="name" className="block text-xs font-bold text-gray-900 mb-1">Full Name</label>
                <input
                  id="name"
                  name="name"
                  type="text"
              ...
              <div>
                <label htmlFor="password" className="block text-xs font-bold text-gray-900 mb-1">Password</label>
                <input
                  id="password"
                  name="password"
                  type="password"
              ...
              <div>
                <label htmlFor="referralCode" className="block text-xs font-bold text-gray-900 mb-1">Referral Code (Optional)</label>
                <input
                  id="referralCode"
                  name="referralCode"
                  type="text"
