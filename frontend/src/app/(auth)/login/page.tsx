    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-black py-12 px-4">
      ...
      <div className="relative z-20 w-full max-w-md bg-white rounded-[1.75rem] p-6 sm:p-8 shadow-2xl border border-white/20">
        <div className="space-y-4">
          ...
          {authMethod === 'OTP' ? (
            !otpSent ? (
              <form className="mt-3 space-y-3.5" onSubmit={handleSendOtp}>
                <div>
                  <label
                    htmlFor="login-phone"
                ...
                <div className="space-y-3 pt-1">
                  ...
                  <button
                    ...
                    className="w-full flex justify-center items-center gap-2 py-2.5 px-4 text-sm font-bold rounded-xl text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 focus:outline-none transition"
                  >
                    <svg
                      className="w-4 h-4"
                      viewBox="0 0 24 24"
              ...
              <form className="mt-3 space-y-4" onSubmit={handleVerifyOtp}>
                <div>
            ...
            <form className="mt-3 space-y-3.5" onSubmit={handlePasswordSubmit}>
              <div>
                <label
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <Link
                    ...
                    className="text-[10px] text-gray-500 hover:text-black font-bold hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              <div className="space-y-3 pt-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="disabled:opacity-50 w-full flex justify-center py-2.5 px-4 text-sm font-bold rounded-xl text-white bg-black hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-black transition shadow-md"
                >
